...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MountDriveBox = QtWidgets.QComboBox(parent=self.centralwidget)
        self.MountDriveBox.setGeometry(QtCore.QRect(100, 10, 151, 22))
        self.MountDriveBox.setObjectName("MountDriveBox")
        self.label_3 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(10, 10, 91, 16))
        self.label_3.setObjectName("label_3")
        self.refreshDrivesBtn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.refreshDrivesBtn.setGeometry(QtCore.QRect(260, 10, 75, 23))
        self.refreshDrivesBtn.setObjectName("refreshDrivesBtn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refreshDrivesBtn.setText(_translate("MainWindow", "Refresh"))
